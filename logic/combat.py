...
class Projectile:
    def __init__(self, x, y, direction, speed, damage, owner_id):
        self.x = x
        self.y = y
...
class CombatManager:
    ...
    def spawn_projectile(self, x, y, direction, ability_type, owner_id):
        if ability_type == "fireball":
            self.projectiles.append(Projectile(x, y, direction, speed=600, damage=10, owner_id=owner_id))
        elif ability_type == "heavy_attack":
            self.projectiles.append(Projectile(x, y, direction, speed=400, damage=25, owner_id=owner_id))
